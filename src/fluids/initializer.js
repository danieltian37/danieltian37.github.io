...
export function activator(canvas, webGL, colorFormat, PROGRAMS, pointers) {
    ...
    canvas.addEventListener('mousemove', e => {
        ...
        console.log(e.x - rect.left, e.y - rect.top, "calculated offset")
        console.log(e.offsetX, e.offsetY, "moved")
    });

    canvas.addEventListener('customDrag', function(e) {
        console.log(e);
        pointers[0].moved = true;
        pointers[0].dx = (e.clientX  - pointers[0].x) * 20;
